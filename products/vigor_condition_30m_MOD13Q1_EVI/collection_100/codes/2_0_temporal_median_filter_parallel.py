...
def createOutputImage(referenceFile, outputFile, startRow, xSize, data, imageFormat = 'GTiff'):
  ...
  outRaster = driver.Create(outputFile, xSize, ySize, 1, referenceBand.DataType, [ 'COMPRESS=LZW','TILED=YES','BIGTIFF=YES' ])
...
def applyFilter(data):
  return median_filter(data, size=(5,1,1),mode = 'reflect')
